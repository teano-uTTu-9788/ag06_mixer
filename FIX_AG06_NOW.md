# 🚨 AG06 URGENT FIX - Device Powered but Not Detected

## IMMEDIATE ACTIONS (Do These Now):

### 1. ✅ CHECK AG06 BACK PANEL SWITCH
**CRITICAL**: There's a switch on the back of AG06!
- **MUST be set to**: `PC/MAC` mode (NOT iOS mode)
- If it's on iOS, that's why Mac can't see it!
- Switch it and the AG06 should appear immediately

### 2. 🔌 CHECK USB CABLE & PORT
The AG06 has TWO USB ports:
- **5V DC**: Power only (don't use this one for Mac)
- **USB 2.0**: Data connection (USE THIS ONE)

Make sure:
- USB cable is connected to the **USB 2.0** port on AG06
...
1. Unplug AG06 from Mac
2. Turn OFF AG06 power
3. Check switch is on PC/MAC mode
4. Plug USB into AG06's USB 2.0 port
5. Plug into Mac
6. Turn ON AG06 power
7. Wait 10 seconds

### 4. 🖥️ CHECK AUDIO MIDI SETUP
I've opened Audio MIDI Setup for you.
- Look in the left panel
- AG06 should appear if properly connected
...
2. Search: "AG06 driver macOS"
3. Download latest version
4. Install and RESTART Mac

### 6. 🎯 QUICK DIAGNOSTIC

Run this to check if AG06 appears after fixes:
```bash
system_profiler SPUSBDataType | grep -i "yamaha\|ag06\|0499"
```
...
## 💡 CURRENT WORKAROUND:
While fixing AG06, AiOke is fully functional at:
